...
data "akamai_property_rules_builder" "ion_standard_rule_accelerate_delivery" {
  rules_v2026_01_09 {
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_origin_connectivity.json,
      data.akamai_property_rules_builder.ion_standard_rule_protocol_optimizations.json,
      data.akamai_property_rules_builder.ion_standard_rule_prefetching.json,
      data.akamai_property_rules_builder.ion_standard_rule_adaptive_acceleration.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_origin_connectivity" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_protocol_optimizations" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_prefetching" {
  rules_v2026_01_09 {
    name                  = "Prefetching"
    comments              = "Instruct edge servers to retrieve embedded resources before the browser requests them."
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_prefetching_objects.json,
      data.akamai_property_rules_builder.ion_standard_rule_prefetchable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_adaptive_acceleration" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_prefetching_objects" {
  rules_v2026_01_09 {
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_bots.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_prefetchable_objects" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_bots" {
  rules_v2026_01_09 {
    name                  = "Bots"
