...
data "akamai_property_rules_builder" "ion_standard_rule_augment_insights" {
  rules_v2026_01_09 {
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_traffic_reporting.json,
      data.akamai_property_rules_builder.ion_standard_rule_m_pulse_rum.json,
      data.akamai_property_rules_builder.ion_standard_rule_geolocation.json,
      data.akamai_property_rules_builder.ion_standard_rule_log_delivery.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_traffic_reporting" {
  rules_v2026_01_09 {
    ...
    behavior {
      cp_code {
        ...
        value {
          ...
          id           = var.rule_traffic_reporting_cp_code
          name         = "jaescalo - DSA/ION & NetStorage"
          products     = ["Site_Accel", "Fresca", ]
        }
      }
    }
  }
...
data "akamai_property_rules_builder" "ion_standard_rule_m_pulse_rum" {
  rules_v2026_01_09 {
    name                  = "mPulse RUM"
...
data "akamai_property_rules_builder" "ion_standard_rule_geolocation" {
  rules_v2026_01_09 {
    name                  = "Geolocation"
...
data "akamai_property_rules_builder" "ion_standard_rule_log_delivery" {
  rules_v2026_01_09 {
    name                  = "Log delivery"
