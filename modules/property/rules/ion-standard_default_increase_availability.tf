...
data "akamai_property_rules_builder" "ion_standard_rule_increase_availability" {
  rules_v2026_01_09 {
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_simulate_failover.json,
      data.akamai_property_rules_builder.ion_standard_rule_site_failover.json,
      data.akamai_property_rules_builder.ion_standard_rule_origin_health.json,
      data.akamai_property_rules_builder.ion_standard_rule_script_management.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_simulate_failover" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_site_failover" {
  rules_v2026_01_09 {
    name                  = "Site failover"
...
data "akamai_property_rules_builder" "ion_standard_rule_origin_health" {
  rules_v2026_01_09 {
    name                  = "Origin health"
...
data "akamai_property_rules_builder" "ion_standard_rule_script_management" {
  rules_v2026_01_09 {
