...
data "akamai_property_rules_builder" "ion_standard_rule_minimize_payload" {
  rules_v2026_01_09 {
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_compressible_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_compressible_objects" {
  rules_v2026_01_09 {
