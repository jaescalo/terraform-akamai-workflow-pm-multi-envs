...
data "akamai_property_rules_builder" "ion_standard_rule_offload_origin" {
  rules_v2026_01_09 {
    name                  = "Offload origin"
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_css_and_java_script.json,
      data.akamai_property_rules_builder.ion_standard_rule_fonts.json,
      data.akamai_property_rules_builder.ion_standard_rule_images.json,
      data.akamai_property_rules_builder.ion_standard_rule_files.json,
      data.akamai_property_rules_builder.ion_standard_rule_other_static_objects.json,
      data.akamai_property_rules_builder.ion_standard_rule_html_pages.json,
      data.akamai_property_rules_builder.ion_standard_rule_redirects.json,
      data.akamai_property_rules_builder.ion_standard_rule_post_responses.json,
      data.akamai_property_rules_builder.ion_standard_rule_graph_ql.json,
      data.akamai_property_rules_builder.ion_standard_rule_uncacheable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_css_and_java_script" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_fonts" {
  rules_v2026_01_09 {
    name                  = "Fonts"
...
data "akamai_property_rules_builder" "ion_standard_rule_images" {
  rules_v2026_01_09 {
    name                  = "Images"
...
data "akamai_property_rules_builder" "ion_standard_rule_files" {
  rules_v2026_01_09 {
    name                  = "Files"
...
data "akamai_property_rules_builder" "ion_standard_rule_other_static_objects" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_html_pages" {
  rules_v2026_01_09 {
    name                  = "HTML pages"
...
data "akamai_property_rules_builder" "ion_standard_rule_redirects" {
  rules_v2026_01_09 {
    name                  = "Redirects"
...
data "akamai_property_rules_builder" "ion_standard_rule_post_responses" {
  rules_v2026_01_09 {
    name                  = "POST responses"
...
data "akamai_property_rules_builder" "ion_standard_rule_graph_ql" {
  rules_v2026_01_09 {
    name                  = "GraphQL"
...
data "akamai_property_rules_builder" "ion_standard_rule_uncacheable_objects" {
  rules_v2026_01_09 {
