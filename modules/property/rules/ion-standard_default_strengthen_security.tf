...
data "akamai_property_rules_builder" "ion_standard_rule_strengthen_security" {
  rules_v2026_01_09 {
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_allowed_methods.json,
      data.akamai_property_rules_builder.ion_standard_rule_obfuscate_debug_info.json,
      data.akamai_property_rules_builder.ion_standard_rule_obfuscate_backend_info.json,
      data.akamai_property_rules_builder.ion_standard_rule_hsts.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_allowed_methods" {
  rules_v2026_01_09 {
    ...
    children = [
      data.akamai_property_rules_builder.ion_standard_rule_post.json,
      data.akamai_property_rules_builder.ion_standard_rule_options.json,
      data.akamai_property_rules_builder.ion_standard_rule_put.json,
      data.akamai_property_rules_builder.ion_standard_rule_delete.json,
      data.akamai_property_rules_builder.ion_standard_rule_patch.json,
    ]
  }
}

data "akamai_property_rules_builder" "ion_standard_rule_obfuscate_debug_info" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_obfuscate_backend_info" {
  rules_v2026_01_09 {
...
data "akamai_property_rules_builder" "ion_standard_rule_hsts" {
  rules_v2026_01_09 {
    name                  = "HSTS"
...
data "akamai_property_rules_builder" "ion_standard_rule_post" {
  rules_v2026_01_09 {
    name                  = "POST"
...
data "akamai_property_rules_builder" "ion_standard_rule_options" {
  rules_v2026_01_09 {
    name                  = "OPTIONS"
...
data "akamai_property_rules_builder" "ion_standard_rule_put" {
  rules_v2026_01_09 {
    name                  = "PUT"
...
data "akamai_property_rules_builder" "ion_standard_rule_delete" {
  rules_v2026_01_09 {
    name                  = "DELETE"
...
data "akamai_property_rules_builder" "ion_standard_rule_patch" {
  rules_v2026_01_09 {
    name                  = "PATCH"
